...
<div class="form-group ">
    <div class="col-sm-2 control-label">
        <label>Link embe</label>
    </div>
    <div class="col-sm-10">
        {{ Form::text('link_embe',$model->link_embe,['class'=>'form-control','placeholder'=>"Enter ..."])}}

        <span class="text-red"><?= ($errors->has('link_embe'))? $errors->first('link_embe'):''; ?></span>
    </div>
</div>
