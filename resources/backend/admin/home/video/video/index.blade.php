              ...
              <section class="vbox">          
                <section class="scrollable padder">
                   <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    <li><a href="#"><i class="fa fa-home"></i>Video</a></li>
                </ul>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel panel-default">
                            <header class="panel-heading">
                                <a type="btn" class="btn btn-success pull-right btn-sm "  href="{{ url('admin/video/create') }}">Thêm</a>
                                Video
                            </header>
                             ...
                             <table class="table table-striped m-b-none">
                                ...
                                <tbody>
                                    <?php foreach ($model as $key ):?>
                                        ...
                                        <td>{{$key['orders']}} </td>
                                        <td>
                                            <a href="{{ url('admin/video/update') }}<?php echo('/'.$key['id']); ?>" title="Edit"> <i class="fa  fa-edit "></i></a> 
                                            <a title="close" class="close_id" href="{{ url('admin/video/delete') }}<?php echo('/'.$key['id']); ?>"> 
