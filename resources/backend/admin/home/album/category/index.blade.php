                    ...
                    <div class="col-xs-12">
                        <div class="panel panel-default">
                            <header class="panel-heading">
                                <a type="btn" class="btn btn-success pull-right btn-sm "  href="{{ url('admin/album_category/create') }}">Thêm</a>
                                Danh mục album
                            </header>
                                ...
                                <tbody>
                                    <?php foreach ($category as $key ):?>
                                        <tr>
                                            ...
                                            <td>{{$key['orders']}} </td>
                                            <td>
                                                <a href="{{ url('admin/album_category/update') }}<?php echo('/'.$key['id']); ?>" title="Edit"> <i class="fa  fa-edit "></i></a> 
                                                <a title="close" class="close_id" href="{{ url('admin/album_category/delete') }}<?php echo('/'.$key['id']); ?>"> 
