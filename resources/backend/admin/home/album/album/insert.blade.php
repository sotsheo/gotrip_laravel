                        ...
                        <div class="panel panel-default">
                            <header class="panel-heading">
                                <ul class="nav nav-tabs nav-justified">
                                    ...
                                    <li class=""><a href="#profile" data-toggle="tab">Hình ảnh liên quan</a></li>
                                ...
                                <div class="tab-content">
                                    {{ Form::open(['files' =>'true']) }}
                                        <div class="tab-pane active" id="home">
                                            @include('admin/home/album/album/base/_form',
                                                ['errors'=>$errors,
                                                'model'=>$model,
                                                'name'=>'Chỉnh sửa'])
                                        </div>
                                        <div class="tab-pane"  id="profile">
                                            @include('admin/home/album/album/base/_form_img',
                                                ['errors'=>$errors,
                                                'model'=>$model,
                                                'name'=>'Chỉnh sửa'])
                                        </div>
                                        <div class="tab-pane"  id="seo">
                                            @include('admin/home/album/album/base/_form_seo',
                                                ['errors'=>$errors,
                                                'model'=>$model,
                                                'name'=>'Chỉnh sửa'])
                                        </div>
