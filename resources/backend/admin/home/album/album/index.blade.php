              ...
              <section class="vbox">          
                <section class="scrollable padder">
                   <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    <li><a href="#"><i class="fa fa-home"></i> Album</a></li>
                </ul>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel panel-default">
                            <header class="panel-heading">
                                <a type="btn" class="btn btn-success pull-right btn-sm "  href="{{ url('admin/album/create') }}">Thêm</a>
                                Album
                            </header>
                             ...
                             <table class="table table-striped m-b-none">
                                ...
                                <tbody>
                                    <?php foreach ($model as $key ):?>
                                        ...
                                        <td>{{$key['orders']}} </td>
                                        <td>
                                            <a href="{{ url('admin/album/update') }}<?php echo('/'.$key['id']); ?>" title="update"> <i class="fa  fa-edit "></i>
                                            </a> 
                                            <a title="close" class="close_id" href="{{ url('admin/album/delete') }}<?php echo('/'.$key['id']); ?>"> 
