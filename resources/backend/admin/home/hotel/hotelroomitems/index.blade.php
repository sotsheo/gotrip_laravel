              ...
              <section class="vbox">          
                <section class="scrollable padder">
                 <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    <li><a href="#"><i class="fa fa-home"></i> Tiện ích phòng</a></li>
                </ul>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel panel-default">
                            <header class="panel-heading">
                                <a type="btn" class="btn btn-success pull-right btn-sm "  href="{{ url('admin/hotel/room/items/create') }}">Thêm</a>
                                Tiện ích phòng
                            </header>
                                            ...
                                            <?php foreach ($model as $key ):?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('admin/hotel/room/items/update') }}<?php echo('/'.$key->id); ?>" title="Update"> <i class="fa  fa-edit "></i></a> 

                                                        <a title="close" class="close_id" href="{{ url('admin/hotel/room/items/delete') }}<?php echo('/'.$key->id); ?>"> <i class="fa fa-trash-o"></i></a>
                                                    </td>
