                    ...
                    <div class="col-xs-12">
                        <div class="panel panel-default">
                            <header class="panel-heading">
                                <a type="btn" class="btn btn-success pull-right btn-sm "  href="{{ url('admin/hotel/create') }}">Thêm</a>
                                Combo
                            </header>
                                            ...
                                            <?php foreach ($model as $key ):?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('admin/hotel/update') }}<?php echo('/'.$key->id); ?>" title="Edit"> <i class="fa  fa-edit "></i></a> 

                                                        <a title="close" class="close_id" href="{{ url('admin/hotel/delete') }}<?php echo('/'.$key->id); ?>"> <i class="fa fa-trash-o"></i></a>
                                                    </td>
