              ...
              <section class="vbox">          
                <section class="scrollable padder">
                   <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    <li><a href="#"><i class="fa fa-home"></i>Khách sạn</a></li>
                </ul>
                <div class="row">
                    <div class="col-xs-12">
                            ...
                            <header class="panel-heading">
                                <ul class="nav nav-tabs nav-justified">
                                    ...
                                    <li class=""><a href="#img" data-toggle="tab">Hình ảnh</a></li>
                                     <li class=""><a href="#address" data-toggle="tab">Địa chỉ</a></li>
                                ...
                                <div class="tab-content">
                                   {{ Form::open(['files' =>'true']) }}
                                        <div class="tab-pane active" id="home">
                                            @include('admin/home/hotel/hotel/base/_form',
                                                ['errors'=>$errors,
                                                'model'=>$model])
                                        </div>
                                        <div class="tab-pane " id="item">
                                            @include('admin/home/hotel/hotel/base/items',
                                                ['errors'=>$errors,
                                                'item'=>$item])
                                        </div>
                                         <div class="tab-pane " id="img">
                                            @include('admin/home/hotel/hotel/base/_form_img',
                                            ['errors'=>$errors, 'model'=>$model])
                                        </div>
                                        <div class="tab-pane " id="address">
                                             @include('admin/home/hotel/hotel/base/hotel_address',
                                                ['errors'=>$errors,
                                                'model'=>$model])
                                        </div>
                                         <div class="tab-pane " id="seo">
                                             @include('admin/home/hotel/hotel/base/seo',
                                                ['errors'=>$errors,
                                                'model'=>$model])
                                        </div>
