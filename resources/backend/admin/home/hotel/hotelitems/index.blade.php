...
<html>
<head>
    <title>Tiện ích khách sạn</title>
                    ...
                    <div class="col-xs-12">
                        <div class="panel panel-default">
                            <header class="panel-heading">
                                <a type="btn" class="btn btn-success pull-right btn-sm "  href="{{ url('admin/hotel/items/create') }}">Thêm</a>
                                Tiện ích khách sạn
                            </header>
                                            ...
                                            <?php foreach ($model as $key ):?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('admin/hotel/items/update') }}<?php echo('/'.$key->id); ?>" title="Update"> <i class="fa  fa-edit "></i></a> 

                                                        <a title="close" class="close_id" href="{{ url('admin/hotel/items/delete') }}<?php echo('/'.$key->id); ?>"> <i class="fa fa-trash-o"></i></a>
                                                    </td>
