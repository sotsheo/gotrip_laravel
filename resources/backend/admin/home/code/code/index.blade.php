              ...
              <section class="vbox">          
                <section class="scrollable padder">
                 <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    <li><a href="#"><i class="fa fa-home"></i> Code</a></li>
                </ul>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel panel-default">
                            <header class="panel-heading">
                                <a type="btn" class="btn btn-success pull-right btn-sm "  href="{{ url('admin/code/create') }}">Thêm</a>
                                Code
                            </header>
                                        ...
                                        <tbody>
                                            <?php foreach ($model as $key ):?>
                                                <tr>
                                                    ...
                                                    <td>{{ $key->name }}</td>
                                                   	<td>{{ $key->number_code }}</td>
                                                    <td>
                                                       
                                                        <a href="{{ url('admin/code/update') }}<?php echo('/'.$key->id); ?>" title="Edit"> <i class="fa  fa-edit "></i></a> 

                                                        <a title="close" class="close_id" href="{{ url('admin/code/delete') }}<?php echo('/'.$key->id); ?>"> <i class="fa fa-trash-o"></i></a>
                                                    </td>
