                            ...
                            <header class="panel-heading">
                                <ul class="nav nav-tabs nav-justified">
                                    <li class="active"><a href="#home" data-toggle="tab">Thông tin </a></li>
                                     <li class=""><a href="#code" data-toggle="tab">Mã code </a></li>
                                ...
                                <div class="tab-content">
                                    {{ Form::open(['files' =>'true']) }}
                                        <div class="tab-pane active" id="home">
                                            @include('admin/home/code/code/base/_form',
                                                ['errors'=>$errors,
                                                'model'=>$model])
                                        </div>
                                        <div class="tab-pane " id="code">
                                            @include('admin/home/code/code/base/_code',
                                                ['errors'=>$errors,
                                                'model'=>$model,'code_item'=>$code_item])
                                        </div>
