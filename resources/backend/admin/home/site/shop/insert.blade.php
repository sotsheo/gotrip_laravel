              ...
              <section class="vbox">          
                <section class="scrollable padder">
                   <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    <li><a href="#"><i class="fa fa-home"></i> Shop</a></li>
                </ul>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel panel-default">
                            <header class="panel-heading">
                                <ul class="nav nav-tabs nav-justified">
                                    ...
                                    <li class=""><a href="#profile" data-toggle="tab">Hình ảnh</a></li>
                                ...
                                <div class="tab-content">
                                    {{ Form::open(['files' =>'true']) }}
                                        <div class="tab-pane active" id="home">
                                           @include('admin/home/site/shop/base/_form',
                                                ['errors'=>$errors,
                                                'model'=>$model,
                                                'name'=>'Chỉnh sửa'])
                                        </div>
                                        <div class="tab-pane"  id="profile">
                                            @include('admin/home/site/shop/base/_form_images',
                                                ['errors'=>$errors,
                                                'model'=>$model,
                                                'name'=>'Chỉnh sửa'])
                                        </div>
